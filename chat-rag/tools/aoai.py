...
class AzureOpenAIClient:
    def __init__(self, document_filename: str = ""):
        ...
        self.endpoint             = os.environ.get("AOAI_ENDPOINT")        # e.g. "https://<your-resource>.openai.azure.com/"
        self.api_version          = os.environ.get("OPENAI_API_VERSION", "2024-10-21")
        self.chat_deployment      = os.environ.get("MODEL_DEPLOYMENT_NAME")         # deployment name in Azure OpenAI Studio
        self.embedding_deployment = os.environ.get("EMBEDDING_MODEL_DEPLOYMENT_NAME")
